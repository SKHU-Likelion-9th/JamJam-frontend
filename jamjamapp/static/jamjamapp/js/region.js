...
function showgyeonggi() {
    var s1 = document.getElementById("gyeonggi");

    s1.innerHTML = "<li><input type='checkbox' id='gapyeonggun'>가평군</li><li><input type='checkbox' id='gapyeonggun'>가평군</li><li><input type='checkbox' id='yangpyeonggun'>양평군</li><li><input type='checkbox' id='yeoncheongun'>연천군</li><li><input type='checkbox' id='goyangsi'>고양시</li><li><input type='checkbox' id='gwacheonsi'>과천시</li><li><input type='checkbox' id='gwangmyeongsi'>광명시</li><li><input type='checkbox' id='gwangjusi'>광주시</li><li><input type='checkbox' id='gurisi'>구리시</li><li><input type='checkbox' id='gunposi'>군포시</li><li><input type='checkbox' id='gimposi'>김포시</li><li><input type='checkbox' id='namyangjusi'>남양주시</li><li><input type='checkbox' id='dongducheongsi'>동두천시</li><li><input type='checkbox' id='bucheonsi'>부천시</li><li><input type='checkbox' id='seongnamsi'>성남시</li><li><input type='checkbox' id='suwonsi'>수원시</li><li><input type='checkbox' id='siheungsi'>시흥시</li><li><input type='checkbox' id='ansansi'>안산시</li><li><input type='checkbox' id='anseongsi'>안성시</li><li><input type='checkbox' id='anyangsi'>안양시</li><li><input type='checkbox' id='yangjusi'>양주시</li><li><input type='checkbox' id='yeojusi'>여주시</li><li><input type='checkbox' id='osansi'>오산시</li><li><input type='checkbox' id='yonginsi'>용인시</li><li><input type='checkbox' id='uiwangsi'>의왕시</li><li><input type='checkbox' id='uijeongbusi'>의정부시</li><li><input type='checkbox' id='icheonsi'>이천시</li><li><input type='checkbox' id='pajusi'>파주시</li><li><input type='checkbox' id='pyeongtaeksi'>평택시</li><li><input type='checkbox' id='pocheonsi'>포천시</li><li><input type='checkbox' id='hanamsi'>하남시</li><li><input type='checkbox' id='hwaseongsi'>화성시</li>";
...
function showincheon() {
    var s1 = document.getElementById("incheon");

    s1.innerHTML = "<li><input type='checkbox' id='junggu_i'>중구</li><li><input type='checkbox' id='donggu_i'>동구</li><li><input type='checkbox' id='michuholgu'>미추홀구</li><li><input type='checkbox' id='yeonsugu'>연수구</li><li><input type='checkbox' id='namdonggu'>남동구</li><li><input type='checkbox' id='bupyeonggu'>부평구</li><li><input type='checkbox' id='gyeuanggu'>계양구</li><li><input type='checkbox' id='seoyanggu'>서양구</li><li><input type='checkbox' id='seogu_i'>서구</li><li><input type='checkbox' id='ganghwagun'>강화군</li><li><input type='checkbox' id='ongjingun'>옹진군</li>";
...
function showdaejeon() {
  var s1 = document.getElementById("daejeon");

  s1.innerHTML = "<li><input type='checkbox' id='donggu_dj'>동구</li><li><input type='checkbox' id='junggu_dj'>중구</li><li><input type='checkbox' id='seogu_dj'>서구</li><li><input type='checkbox' id='yooseonggu'>유성구</li><li><input type='checkbox' id='daedeokgu'>대덕구</li>";
...
function showjeonbuk() {
  var s1 = document.getElementById("jeonbuk");

  s1.innerHTML = "<li><input type='checkbox' id='jeonjusi'>전주시</li><li><input type='checkbox' id='gunsansi'>군산시</li><li><input type='checkbox' id='iksansi'>익산시</li><li><input type='checkbox' id='jeongeupsi'>정읍시</li><li><input type='checkbox' id='namwonsi'>남원시</li><li><input type='checkbox' id='gimjesi'>김제시</li><li><input type='checkbox' id='wanjugun'>완주군</li><li><input type='checkbox' id='jinangun'>진안군</li><li><input type='checkbox' id='mujugun'>무주군</li><li><input type='checkbox' id='jangsugun'>장수군</li><li><input type='checkbox' id='imsilgun'>임실군</li><li><input type='checkbox' id='sunchanggun'>순창군</li><li><input type='checkbox' id='gochanggun'>고창군</li><li><input type='checkbox' id='buangun'>부안군</li>";
...
function showgwangju() {
  var s1 = document.getElementById("gwangju");

  s1.innerHTML = "<li><input type='checkbox' id='gwangsangu'>광산구</li><li><input type='checkbox' id='donggu_j'>동구</li><li><input type='checkbox' id='seogu_j'>서구</li><li><input type='checkbox' id='namgu_j'>남구</li><li><input type='checkbox' id='bukgu_j'>북구</li>";
...
function showgyeongnam() {
  var s1 = document.getElementById("gyeongnam");

  s1.innerHTML = "<li><input type='checkbox' id='changwonsi'>창원시</li><li><input type='checkbox' id='gimhaesi'>김해시</li><li><input type='checkbox' id='yangsansi'>양산시</li><li><input type='checkbox' id='jinjusi'>진주시</li><li><input type='checkbox' id='geojesi'>거제시</li><li><input type='checkbox' id='tongyeongsi'>통영시</li><li><input type='checkbox' id='sacheonsi'>사천시</li><li><input type='checkbox' id='miryangsi'>밀양시</li><li><input type='checkbox' id='hamangun'>함안군</li><li><input type='checkbox' id='geochanggun'>거창군</li><li><input type='checkbox' id='changnyeonggun'>창녕군</li><li><input type='checkbox' id='goseonggun'>고성군</li><li><input type='checkbox' id='hadonggun'>하동군</li><li><input type='checkbox' id='hapcheongun'>합천군</li><li><input type='checkbox' id='namhaegun'>남해군</li><li><input type='checkbox' id='hamyanggun'>함양군</li><li><input type='checkbox' id='sancheonggun'>산청군</li><li><input type='checkbox' id='uiryeonggun'>의령군</li>";
...
function showulsan() {
  ...
  s1.innerHTML = "<li><input type='checkbox' id='junggu_u'>중구</li><li><input type='checkbox' id='namgu_u'>남구</li><li><input type='checkbox' id='donggu_u'>동구</li><li><input type='checkbox' id='bukgu_u'>북구</li><li><input type='checkbox' id='uljugun'>울주군</li>";
...
function showjeju() {
  var s1 = document.getElementById("jeju");

  s1.innerHTML = "<li><input type='checkbox' id='jejusi'>제주시</li><li><input type='checkbox' id='seogwiposi'>서귀포시</li>";
